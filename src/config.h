...
#define EPONA_GLOBAL_TURN_MULT 1.5f
...
#define WALK_SPEED_ARGS 0.3f, -0.5f, 10.0f, 0.06f, 3.0f, 800
#define TROT_SPEED_ARGS 0.3f, -0.5f, 10.0f, 0.06f, 6.0f, 1600
#define GALLOP_SPEED_ARGS 0.3f, -0.5f, 10.0f, 0.06f, 8.0f, 1600
